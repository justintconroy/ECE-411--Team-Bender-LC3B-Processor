...
-- CONTROL SIGNAL WIDTHS
	SUBTYPE LC3B_CONTROL_INPUT_WORD is STD_LOGIC_VECTOR(5 DOWNTO 0);
	SUBTYPE LC3B_CONTROL_WORD is STD_LOGIC_VECTOR(8 DOWNTO 0);
...
-- CACHE SIGNAL WIDTHS
	...
	CONSTANT CONT_ADDR     : LC3B_CONTROL_INPUT_WORD := OP_ADD & "X0";
	CONSTANT CONT_ADDR0    : LC3B_CONTROL_INPUT_WORD := OP_ADD & "00";
	CONSTANT CONT_ADDR1    : LC3B_CONTROL_INPUT_WORD := OP_ADD & "10";
	CONSTANT CONT_ADDI0    : LC3B_CONTROL_INPUT_WORD := OP_ADD & "01";
	CONSTANT CONT_ADDI1    : LC3B_CONTROL_INPUT_WORD := OP_ADD & "11";

	CONSTANT CONT_ANDR0    : LC3B_CONTROL_INPUT_WORD := OP_AND & "00";
	CONSTANT CONT_ANDR1    : LC3B_CONTROL_INPUT_WORD := OP_AND & "10";
	CONSTANT CONT_ANDI0    : LC3B_CONTROL_INPUT_WORD := OP_AND & "01";
	CONSTANT CONT_ANDI1    : LC3B_CONTROL_INPUT_WORD := OP_AND & "11";

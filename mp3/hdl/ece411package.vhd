...
-- CACHE SIGNAL WIDTHS
	...
	SUBTYPE LC3B_CACHEINDEX IS STD_LOGIC_VECTOR(2 DOWNTO 0);
	SUBTYPE LC3B_CACHEOFFSET IS STD_LOGIC_VECTOR(2 DOWNTO 0);
	...
	CONSTANT DELAY_COMP : TIME := 5 NS;
	CONSTANT DELAY_HITGATE : TIME := 34 NS;

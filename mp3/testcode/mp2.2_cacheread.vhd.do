echo "--- Executing initialization force file for mp2.2_cacheread.vhd ---"
...
echo "Done initializing processor, loading mp2.2_cacheread.vhd program code."
run 5
...
run 5
echo "Done loading mp2.2_cacheread.vhd program code."
